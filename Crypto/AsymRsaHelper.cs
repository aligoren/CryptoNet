...
namespace CryptoNet
{
    class AsymRsaHelper
    {
        ...
        protected static void GenerateKeys(int keySize, out string publicKey, out string publicAndPrivateKey)
        {
        ...
        protected static string EncryptText(string text, int keySize, string publicKeyXml)
        {
        ...
        protected static string DecryptText(string text, int keySize, string publicAndPrivateKeyXml)
        {
